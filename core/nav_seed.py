...
ADMIN_NAV: list[tuple] = [
    ...
    ("admin", "inventory", "Inventory", "Warehouse", "", 35, "", ""),
    ("admin", "suppliers", "Suppliers", "Truck", "inventory", 0, "", ""),
    ("admin", "stock-purchases", "Stock purchases", "PackagePlus", "inventory", 1, "", ""),
    ("admin", "ledger", "Ledger", "BookText", "inventory", 2, "", ""),
    ...
    ("admin", "wallet-settings", "Wallet Settings", "Settings", "wallet-master", 2, "", ""),
...
VENDOR_NAV: list[tuple] = [
    ...
    ("vendor", "reviews", "Reviews", "Star", "products", 1, "", ""),
