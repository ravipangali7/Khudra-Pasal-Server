...
ADMIN_NAV: list[tuple] = [
    ...
    ("admin", "purchase", "Purchase", "ShoppingBag", "", 45, "", ""),
    ("admin", "purchase-insights", "Purchase insights", "LineChart", "purchase", 0, "", ""),
    ...
    ("admin", "withdrawals", "Seller Withdrawals", "CreditCard", "finance", 2, "admin_pending_withdrawals", ""),
...
VENDOR_NAV: list[tuple] = [
    ...
    ("vendor", "purchase", "Purchase", "ShoppingBag", "", 35, "", ""),
    ("vendor", "purchase-insights", "Purchase insights", "LineChart", "purchase", 0, "", ""),
    ("vendor", "pos", "POS System", "CreditCard", "", 40, "", ""),
    ("vendor", "marketing", "Marketing", "Megaphone", "", 50, "", ""),
    ("vendor", "coupons", "Coupons", "Percent", "marketing", 0, "", ""),
...
PORTAL_FAMILY_NAV: list[tuple] = [
    ...
    ("portal_family", "wallets-load", "Load Money", "Banknote", "wallets", 1, "", "", "wallets"),
    ("portal_family", "wallets-transfer", "Transfer", "Send", "wallets", 2, "", "", "wallets"),
