...
urlpatterns = [
    ...
    path("products/sku-preview/", resource_views.admin_product_sku_preview, name="admin-product-sku-preview"),
    ...
    path(
        ...
        dashboard_views.admin_wallet_topup_connectips_validate,
        name="admin-wallet-topup-connectips-validate",
    ),
